...
CREATE TABLE `access_requests`  (
                                    ...
                                    `database_system_id` int NOT NULL,
                                    ...
                                    INDEX `access_requests_ibfk1`(`user_id` ASC) USING BTREE,
                                    INDEX `access_requests_ibfk2`(`database_system_id` ASC) USING BTREE,
...
CREATE TABLE `password_reset_log`  (
                                       ...
                                       INDEX `user_id_users_user_id_idx`(`user_id` ASC) USING BTREE,
...
INSERT INTO `schema_version` VALUES (5, '4.25.04.21', 'update', 'SQL', 'V4.25.04.21__update.sql', -944328920, 'root', '2025-04-21 09:37:03', 67, 1);
...
CREATE TABLE `unapproved_users`  (
                                     ...
                                     `activation_key` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
                                     PRIMARY KEY (`id`) USING BTREE,
                                     INDEX `unapproved_users_ibfk_1`(`institution_id` ASC) USING BTREE,
                                     INDEX `unapproved_users_ibfk_2`(`database_system_id` ASC) USING BTREE,
                                     CONSTRAINT `unapproved_users_ibfk_1` FOREIGN KEY (`institution_id`) REFERENCES `institutions` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `user_has_access_to_databases`  (
                                                 ...
                                                 INDEX `fk_users_has_databases_databases1_idx`(`database_id` ASC) USING BTREE,
                                                 INDEX `fk_users_has_databases_users1_idx`(`user_id` ASC) USING BTREE,
                                                 INDEX `fk_users_has_access_to_databases_user_types1_idx`(`user_type_id` ASC) USING BTREE,
                                                 CONSTRAINT `user_has_access_to_databases_ibfk_1` FOREIGN KEY (`user_type_id`) REFERENCES `user_types` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `users`  (
                          ...
                          PRIMARY KEY (`id`) USING BTREE,
                          INDEX `fk_users_institutions1_idx`(`institution_id` ASC) USING BTREE,
