...
public class UnapprovedUsers extends TableImpl<UnapprovedUsersRecord>
{
     ...
     */
    public final         TableField<UnapprovedUsersRecord, Integer>   ID                  = createField("id", SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.user_username</code>.
     */
    public final         TableField<UnapprovedUsersRecord, String>    USER_USERNAME       = createField("user_username", SQLDataType.VARCHAR(45).nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.user_password</code>.
     */
    public final         TableField<UnapprovedUsersRecord, String>    USER_PASSWORD       = createField("user_password", SQLDataType.VARCHAR(128).nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.user_full_name</code>.
     */
    public final         TableField<UnapprovedUsersRecord, String>    USER_FULL_NAME      = createField("user_full_name", SQLDataType.VARCHAR(128).nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.user_email_address</code>.
     */
    public final         TableField<UnapprovedUsersRecord, String>    USER_EMAIL_ADDRESS  = createField("user_email_address", SQLDataType.VARCHAR(128).nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.institution_id</code>.
     */
    public final         TableField<UnapprovedUsersRecord, Integer>   INSTITUTION_ID      = createField("institution_id", SQLDataType.INTEGER, this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.institution_name</code>.
     */
    public final         TableField<UnapprovedUsersRecord, String>    INSTITUTION_NAME    = createField("institution_name", SQLDataType.VARCHAR(128), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.institution_acronym</code>.
     */
    public final         TableField<UnapprovedUsersRecord, String>    INSTITUTION_ACRONYM = createField("institution_acronym", SQLDataType.VARCHAR(45), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.institution_address</code>.
     */
    public final         TableField<UnapprovedUsersRecord, String>    INSTITUTION_ADDRESS = createField("institution_address", SQLDataType.VARCHAR(255), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.database_system_id</code>.
     */
    public final         TableField<UnapprovedUsersRecord, Integer>   DATABASE_SYSTEM_ID  = createField("database_system_id", SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.created_on</code>.
     */
    public final         TableField<UnapprovedUsersRecord, Timestamp> CREATED_ON          = createField("created_on", SQLDataType.TIMESTAMP, this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.has_been_rejected</code>.
     */
    public final         TableField<UnapprovedUsersRecord, Byte>      HAS_BEEN_REJECTED   = createField("has_been_rejected", SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.needs_approval</code>.
     */
    public final         TableField<UnapprovedUsersRecord, Byte>      NEEDS_APPROVAL      = createField("needs_approval", SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("1", SQLDataType.TINYINT)), this, "");
    /**
     * The column <code>germinate_gatekeeper.unapproved_users.activation_key</code>.
     */
    public final         TableField<UnapprovedUsersRecord, String>    ACTIVATION_KEY      = createField("activation_key", SQLDataType.VARCHAR(36), this, "");
