...
import jhi.gatekeeper.server.database.tables.records.DatabaseVersionRecord;
...
public class DatabaseVersion extends TableImpl<DatabaseVersionRecord>
{
     ...
     */
    public final         TableField<DatabaseVersionRecord, Integer>   VERSION          = createField("version", SQLDataType.INTEGER.nullable(false), this, "The version number of this database. Incrementing starting from '1'.");
    /**
     * The column <code>germinate_gatekeeper.database_version.updated_on</code>. The timestamp of the last update.
     */
    public final         TableField<DatabaseVersionRecord, Timestamp> UPDATED_ON       = createField("updated_on", SQLDataType.TIMESTAMP, this, "The timestamp of the last update.");
