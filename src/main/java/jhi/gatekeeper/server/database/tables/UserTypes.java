...
public class UserTypes extends TableImpl<UserTypesRecord>
{
     ...
     */
    public final         TableField<UserTypesRecord, Integer> ID               = createField("id", SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    /**
     * The column <code>germinate_gatekeeper.user_types.description</code>.
     */
    public final         TableField<UserTypesRecord, String>  DESCRIPTION      = createField("description", SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * Create a <code>germinate_gatekeeper.user_types</code> table reference
     */
    public UserTypes()
    {
    ...
    /**
     * Create an aliased <code>germinate_gatekeeper.user_types</code> table reference
     */
