...
public class UserHasAccessToDatabases extends TableImpl<UserHasAccessToDatabasesRecord> {
    ...
    private static final long serialVersionUID = 2128092126;

    /**
     * The reference instance of <code>gatekeeper_db.user_has_access_to_databases</code>
     */
    ...
    /**
     * The column <code>gatekeeper_db.user_has_access_to_databases.user_id</code>.
     */
    ...
    /**
     * The column <code>gatekeeper_db.user_has_access_to_databases.database_id</code>.
     */
    ...
    /**
     * The column <code>gatekeeper_db.user_has_access_to_databases.user_type_id</code>.
     */
    public final TableField<UserHasAccessToDatabasesRecord, Integer> USER_TYPE_ID = createField("user_type_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * Create a <code>gatekeeper_db.user_has_access_to_databases</code> table reference
     */
    ...
    /**
     * Create an aliased <code>gatekeeper_db.user_has_access_to_databases</code> table reference
     */
