...
public class AccessRequests extends TableImpl<AccessRequestsRecord>
{
     ...
     */
    public final         TableField<AccessRequestsRecord, Integer>   ID                 = createField("id", SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    /**
     * The column <code>germinate_gatekeeper.access_requests.user_id</code>.
     */
    public final         TableField<AccessRequestsRecord, Integer>   USER_ID            = createField("user_id", SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.access_requests.database_system_id</code>.
     */
    public final         TableField<AccessRequestsRecord, Integer>   DATABASE_SYSTEM_ID = createField("database_system_id", SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.access_requests.has_been_rejected</code>.
     */
    public final         TableField<AccessRequestsRecord, Byte>      HAS_BEEN_REJECTED  = createField("has_been_rejected", SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)), this, "");
    /**
     * The column <code>germinate_gatekeeper.access_requests.needs_approval</code>.
     */
    public final         TableField<AccessRequestsRecord, Byte>      NEEDS_APPROVAL     = createField("needs_approval", SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("1", SQLDataType.TINYINT)), this, "");
    /**
     * The column <code>germinate_gatekeeper.access_requests.activation_key</code>.
     */
    public final         TableField<AccessRequestsRecord, String>    ACTIVATION_KEY     = createField("activation_key", SQLDataType.VARCHAR(36), this, "");
    /**
     * The column <code>germinate_gatekeeper.access_requests.created_on</code>.
     */
    public final         TableField<AccessRequestsRecord, Timestamp> CREATED_ON         = createField("created_on", SQLDataType.TIMESTAMP, this, "");
