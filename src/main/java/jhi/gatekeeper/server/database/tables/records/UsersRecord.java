...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record9<Integer, String, String, String, String, Timestamp, Timestamp, Integer, Byte> {
    ...
    public UsersRecord(Integer id, String username, String password, String fullName, String emailAddress, Timestamp createdOn, Timestamp lastLogin, Integer institutionId, Byte hasAccessToGatekeeper) {
        ...
        setHasAccessToGatekeeper(hasAccessToGatekeeper);
    }

    /**
     * Create a detached, initialised UsersRecord
     */
    public UsersRecord(jhi.gatekeeper.server.database.tables.pojos.Users value) {
        super(Users.USERS);
        ...
        if (value != null) {
            ...
            setHasAccessToGatekeeper(value.getHasAccessToGatekeeper());
        }
    }
}
