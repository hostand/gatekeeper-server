...
public class ViewCounts extends TableImpl<ViewCountsRecord>
{
     ...
     */
    public final         TableField<ViewCountsRecord, Long> USERS            = createField("users", SQLDataType.BIGINT, this, "");
    /**
     * The column <code>germinate_gatekeeper.view_counts.requests</code>.
     */
    public final         TableField<ViewCountsRecord, Long> REQUESTS         = createField("requests", SQLDataType.BIGINT, this, "");
    /**
     * The column <code>germinate_gatekeeper.view_counts.databases</code>.
     */
    public final         TableField<ViewCountsRecord, Long> DATABASES        = createField("databases", SQLDataType.BIGINT, this, "");
