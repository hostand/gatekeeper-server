...
public class ViewAccessRequestUserDetails extends TableImpl<ViewAccessRequestUserDetailsRecord> {
    ...
    private ViewAccessRequestUserDetails(Name alias, Table<ViewAccessRequestUserDetailsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_access_request_user_details` as select `germinate_gatekeeper_template_4_21_08_31`.`access_requests`.`id` AS `id`,`germinate_gatekeeper_template_4_21_08_31`.`users`.`username` AS `username`,`germinate_gatekeeper_template_4_21_08_31`.`users`.`full_name` AS `full_name`,`germinate_gatekeeper_template_4_21_08_31`.`users`.`email_address` AS `email_address`,`germinate_gatekeeper_template_4_21_08_31`.`access_requests`.`created_on` AS `created_on`,`germinate_gatekeeper_template_4_21_08_31`.`institutions`.`id` AS `institution_id`,`germinate_gatekeeper_template_4_21_08_31`.`institutions`.`name` AS `name`,`germinate_gatekeeper_template_4_21_08_31`.`institutions`.`acronym` AS `acronym`,`germinate_gatekeeper_template_4_21_08_31`.`institutions`.`address` AS `address`,`germinate_gatekeeper_template_4_21_08_31`.`database_systems`.`system_name` AS `database_system_name`,`germinate_gatekeeper_template_4_21_08_31`.`database_systems`.`server_name` AS `database_server_name`,`germinate_gatekeeper_template_4_21_08_31`.`access_requests`.`has_been_rejected` AS `has_been_rejected`,`germinate_gatekeeper_template_4_21_08_31`.`access_requests`.`needs_approval` AS `needs_approval`,`germinate_gatekeeper_template_4_21_08_31`.`access_requests`.`activation_key` AS `activation_key` from (((`germinate_gatekeeper_template_4_21_08_31`.`access_requests` left join `germinate_gatekeeper_template_4_21_08_31`.`users` on((`germinate_gatekeeper_template_4_21_08_31`.`users`.`id` = `germinate_gatekeeper_template_4_21_08_31`.`access_requests`.`user_id`))) left join `germinate_gatekeeper_template_4_21_08_31`.`institutions` on((`germinate_gatekeeper_template_4_21_08_31`.`institutions`.`id` = `germinate_gatekeeper_template_4_21_08_31`.`users`.`institution_id`))) left join `germinate_gatekeeper_template_4_21_08_31`.`database_systems` on((`germinate_gatekeeper_template_4_21_08_31`.`database_systems`.`id` = `germinate_gatekeeper_template_4_21_08_31`.`access_requests`.`database_system_id`))) where (`germinate_gatekeeper_template_4_21_08_31`.`access_requests`.`has_been_rejected` = 0)"));
    }
