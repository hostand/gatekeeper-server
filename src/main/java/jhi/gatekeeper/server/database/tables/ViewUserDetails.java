...
public class ViewUserDetails extends TableImpl<ViewUserDetailsRecord>
{
     ...
     */
    public final         TableField<ViewUserDetailsRecord, Integer>   ID                = createField("id", SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");
    /**
     * The column <code>germinate_gatekeeper.view_user_details.username</code>.
     */
    public final         TableField<ViewUserDetailsRecord, String>    USERNAME          = createField("username", SQLDataType.VARCHAR(45).nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.view_user_details.full_name</code>.
     */
    public final         TableField<ViewUserDetailsRecord, String>    FULL_NAME         = createField("full_name", SQLDataType.VARCHAR(128).nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.view_user_details.email_address</code>.
     */
    public final         TableField<ViewUserDetailsRecord, String>    EMAIL_ADDRESS     = createField("email_address", SQLDataType.VARCHAR(128).nullable(false), this, "");
    /**
     * The column <code>germinate_gatekeeper.view_user_details.created_on</code>.
     */
    public final         TableField<ViewUserDetailsRecord, Timestamp> CREATED_ON        = createField("created_on", SQLDataType.TIMESTAMP, this, "");
    /**
     * The column <code>germinate_gatekeeper.view_user_details.gatekeeper_access</code>.
     */
    public final         TableField<ViewUserDetailsRecord, Byte>      GATEKEEPER_ACCESS = createField("gatekeeper_access", SQLDataType.TINYINT.defaultValue(DSL.inline("1", SQLDataType.TINYINT)), this, "");
    /**
     * The column <code>germinate_gatekeeper.view_user_details.name</code>.
     */
    public final         TableField<ViewUserDetailsRecord, String>    NAME              = createField("name", SQLDataType.VARCHAR(128), this, "");
    /**
     * The column <code>germinate_gatekeeper.view_user_details.acronym</code>.
     */
    public final         TableField<ViewUserDetailsRecord, String>    ACRONYM           = createField("acronym", SQLDataType.VARCHAR(45), this, "");
    /**
     * The column <code>germinate_gatekeeper.view_user_details.address</code>.
     */
    public final         TableField<ViewUserDetailsRecord, String>    ADDRESS           = createField("address", SQLDataType.VARCHAR(255), this, "");
