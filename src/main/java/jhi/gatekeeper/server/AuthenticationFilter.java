...
public class AuthenticationFilter implements ContainerRequestFilter
{
		...
		throws IOException
	{
		...
		requestContext.setSecurityContext(new SecurityContext()
		{
			...
			public Principal getUserPrincipal()
			{
				...
				if (details == null)
				{
					details = new UserDetails(-1000, null, UserType.UNKNOWN, AGE);
				}
	...
	public static void addToken(HttpServletRequest request, HttpServletResponse response, String token, String userType, Integer userId)
	{
		setCookie(token, request, response);
	...
	public static class UserDetails implements Principal
	{
		...
		public UserDetails setUserType(UserType userType)
		{
			this.userType = userType;
			return this;
		}
