...
public class ViewUnapprovedUserDetails implements Serializable {
    ...
    private static final long serialVersionUID = 1092267585;
    ...
    public ViewUnapprovedUserDetails(ViewUnapprovedUserDetails value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ViewUnapprovedUserDetails (");
